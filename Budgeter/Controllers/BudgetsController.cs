...
namespace Budgeter.Controllers
{
    public class BudgetsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,HouseholdId,Amount,Created,Updated")] Budget budget)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,HouseholdId,Amount,Created,Updated")] Budget budget)
        {
            if (ModelState.IsValid)
            {
                budget.Updated = DateTimeOffset.Now;
                db.Entry(budget).State = EntityState.Modified;
                db.Entry(budget).Property("Created").IsModified = false;
                db.SaveChanges();
                return RedirectToAction("Index");
            }
            ViewBag.HouseholdId = new SelectList(db.Households, "Id", "Name", budget.HouseholdId);
